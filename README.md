...
> move/retain semantics + auto-deref), and **multi-file builds with
> private-by-default namespaces** — building for **native** and **WASM**, with
> debug/release builds and **IDE breakpoint debugging**. No raw pointers / no
> `unsafe` by design. New? See **[GETTING_STARTED.md](GETTING_STARTED.md)**.
