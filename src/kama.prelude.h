...
// that replaced the `namespace` declaration (SPEC.md § Modules) cannot reach it — without this
// it falls through to the file-private scope and `std__memory__Owned` becomes `_F<file>__Owned`. That was a
