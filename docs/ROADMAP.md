...
| 11 | **Windows** — long-path support; suite wall-clock (~1819 s on the box, 2026-09-06, against a ~75 s container figure that is older — [windows.md](platforms/windows.md) carries both dates and the caveat) | — | [§1](ROADMAP_DETAIL.md#s1) |
