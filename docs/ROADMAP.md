...
| 4 | **23 `tests/xfail` fixtures use the retired class-named constructor** and pass only because their `.msg` still appears among 2–13 errors; rewrite each to `ctor make` + the brace import and confirm ONE error. Tests only | S | [§1](ROADMAP_DETAIL.md#s1) |
