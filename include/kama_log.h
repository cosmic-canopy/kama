...
// The filter — kama binds this as `extern fn bool kama_log_enabled(int32 level, UnsafeConstPtr<cchar> tag, usize tagLen)`.
...
// `extern fn void kama_log_dispatch(int32 level, UnsafeConstPtr<cchar> tag, usize tagLen, UnsafeConstPtr<cchar> msg, usize msgLen)`.
